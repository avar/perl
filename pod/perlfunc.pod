...
If you need even more information about what your caller wants the
L<Want> module (available on CPAN) might be able to help you. It can
tell you if you're in lvalue context, what item count the caller is
expecting and more.
