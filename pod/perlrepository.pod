...
You should now send an email (L<see below|/"Sending patch emails">) to
either perlbug@perl.org or perl5-porters@perl.org with a description
of your changes, and include this patch file as an attachment. The
perlbug address is preferred, but use perl5-porters for patches
...
previous section|/"Submitting a patch"> with a normal mail client as
an attachment, along with a description of the patch.
